...
export default function AppDownload() {
  return (
    <section id="download" className="py-20 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="relative">
                ...
                <div className="bg-card rounded-2xl p-6 shadow-xl">
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">Funds available instantly</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <motion.div
                className="absolute -bottom-4 -right-4 bg-secondary text-secondary-foreground px-3 py-1 rounded-full text-sm font-medium"
                animate={{ y: [0, 5, 0] }}
