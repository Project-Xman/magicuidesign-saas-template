...
export default function ComplianceHero() {
  return (
    <section id="compliance-hero" className="pt-32 pb-20">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <div className="text-center">
              ...
              <h3 className="font-semibold text-primary mb-2">Bank-Grade Security</h3>
              <p className="text-muted-foreground text-sm">256-bit encryption and SOC 2 compliance</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold text-accent mb-2">Privacy-First Design</h3>
              <p className="text-muted-foreground text-sm">Your data is never sold or shared</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-semibold text-secondary mb-2">Full Compliance</h3>
              <p className="text-muted-foreground text-sm">AML, KYC, and all financial regulations</p>
            </div>
          </motion.div>
        </div>
      </div>
