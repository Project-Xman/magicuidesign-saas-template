...
export default function EmployerCTA() {
  return (
    <section id="employer-cta" className="py-20 bg-gradient-to-r from-primary to-accent">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Link
              href="/contact#demo"
              className={cn(
                "bg-white text-primary hover:bg-gray-50 font-semibold px-8 py-4 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
              )}
            >
              Book a Free Demo
            </Link>
            <Link
              href="/how-it-works"
              className={cn(
                "border-2 border-white text-white hover:bg-white hover:text-primary font-semibold px-8 py-4 text-lg rounded-xl transition-all duration-200"
              )}
            >
              See How It Works
            </Link>
